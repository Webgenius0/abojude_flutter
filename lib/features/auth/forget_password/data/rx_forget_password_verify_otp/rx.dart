...
final class ForgetPasswordVerifyOtpRx extends RxResponseInt<ForgetPasswordVerifyOtpModel> {
  final api = ForgetPasswordVerifyOtpApi.instance;

  ForgetPasswordVerifyOtpRx({required super.empty, required super.dataFetcher});
  ...
  Future<bool> forgetPasswordVerifyOtpRx({
    ...
    try {
      final data = await api.forgetPasswordVerifyOtpApi(
        email: email,
        otp: otp,
        type: type,
      );
