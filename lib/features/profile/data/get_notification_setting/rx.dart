...
import 'package:abojude_flutter/features/profile/data/get_notification_setting/api.dart';
...
final class GetNotificationSettingRx extends RxResponseInt<GetNotificationModel> {
  final api = GetNotificationSettingApi.instance;

  GetNotificationSettingRx({required super.empty, required super.dataFetcher});
  ...
  ValueStream<GetNotificationModel> get getNotificationSettingData => dataFetcher.stream;

  Future<GetNotificationModel> getNotificationSetting() async {
    isLoading.value = true;
    try {
      final data = await api.getNotificationSettingApi();
