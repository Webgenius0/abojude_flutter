...
final class PostSentMessageRx extends RxResponseInt<PostSentMessageModel> {
  final api = PostSentMessageApi.instance;

  PostSentMessageRx({required super.empty, required super.dataFetcher});
