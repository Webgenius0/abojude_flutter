...
class JobStep4ContactScreen extends StatefulWidget {
  final JobListingModel model;

  const JobStep4ContactScreen({super.key, required this.model});

  @override
  State<JobStep4ContactScreen> createState() => _JobStep4ContactScreenState();
}

class _JobStep4ContactScreenState extends State<JobStep4ContactScreen> {
                              ...
                              if (_formKey.currentState!.validate()) {
                                ...
                                createJobRxObj
                                    .createJob(
                                      ...
                                      jobType: [
                                        widget.model.jobType.replaceAll(
                                          '-',
                                          ' ',
                                        ),
                                      ],
