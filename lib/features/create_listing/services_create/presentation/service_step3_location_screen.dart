...
class ServiceStep3LocationScreen extends StatefulWidget {
  final ServiceListingModel model;

  const ServiceStep3LocationScreen({super.key, required this.model});

  @override
  State<ServiceStep3LocationScreen> createState() => _ServiceStep3LocationScreenState();
}

class _ServiceStep3LocationScreenState extends State<ServiceStep3LocationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: const ServiceStepHeader(currentStep: 3, title: "Location"),
      body: SafeArea(
        child: Form(
          key: _formKey,
          child: Column(
