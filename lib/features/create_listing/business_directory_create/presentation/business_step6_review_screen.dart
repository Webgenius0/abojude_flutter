...
class BusinessStep6ReviewScreen extends StatelessWidget {
  final BusinessListingModel model;

  const BusinessStep6ReviewScreen({super.key, required this.model});

  @override
  Widget build(BuildContext context) {
    final coverImage = model.coverImage;

    return Scaffold(
      backgroundColor: Colors.white,
      appBar: const BusinessStepHeader(currentStep: 6, title: "Review & Submit"),
      body: SafeArea(
        child: Column(
          children: [
            Expanded(
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          _buildBulletPoint("You'll receive a push/email notification once approved"),
                          _buildBulletPoint(
